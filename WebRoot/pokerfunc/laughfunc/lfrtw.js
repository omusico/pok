...
function wagerPlaGetText(arrPlaType){
...
function wagerPlaCalEach(){
  var totalQuan=0;
  if(document.all("playmode").value=="前二"){
    totalQuan=arrQuanForPla[0]*arrQuanForPla[1];
  }
  if(document.all("playmode").value=="后二"){
    totalQuan=arrQuanForPla[1]*arrQuanForPla[2];
  }
