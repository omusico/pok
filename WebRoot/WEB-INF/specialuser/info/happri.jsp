   ...
   <tr>
        <td valign=top>
	        <table>
			 <tr>
			  <td>
			   <table align=center width=910 height=90 border=1 cellpadding=0 cellspacing=0 bordercolor=pink>
			    <tr><td colspan=11 height=30 align=center>福彩3D 中奖记录</td></tr>
			    <tr height=20>
			    ...
			    <tr height=20>
			     ...
			     if(strPageType.equals("man")){
			    	 out.print("<td width='10%'><a href=/servlet/useinfprdel?play=hap&prid="+dbcInfo.rsGetString("id")+">删除</a></td>");
			     }
			     %>
			    </tr>
			    <%}%>
			 ...
			 <tr>
			  <td><ctl:page curpage="<%=psInfo.getCurrentPage()%>" maxpage="<%=psInfo.getMaxPage()%>" prevpage="<%=psInfo.getPrevPage()%>" nextpage="<%=psInfo.getNextPage()%>" servhref="servlet/servuserinfo?mark=happri&"></ctl:page>
			  </td>
			 </tr>
	       </table>
        </td>
