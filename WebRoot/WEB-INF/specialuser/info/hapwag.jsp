	        ...
	        <table>
			  ...
			  <td>
			   <table align=center width=910 height=90 border=1 cellpadding=0 cellspacing=0 bordercolor=pink>
			    <tr><td colspan=10 height=30 align=center>福彩3D 投注记录</td></tr>
			    ...
			    <tr height=20 align=center>
			     ...
			     if(strPageType.equals("man")){
			    	 out.print("<td width=30><a href=/servlet/useinfwagrem?play=hap&wagerid="+dbcInfo.rsGetString("id")+">删除</a></td>");
			     }
			     %>
			   <%}%>
			   </table>
			 ...
			 <tr>
			  <td><ctl:page curpage="<%=psInfo.getCurrentPage()%>" maxpage="<%=psInfo.getMaxPage()%>" prevpage="<%=psInfo.getPrevPage()%>" nextpage="<%=psInfo.getNextPage()%>" servhref="servlet/servuserinfo?mark=hapwag&"></ctl:page>
			  </td>
			 </tr>
	       </table>
        </td>
