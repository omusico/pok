  ...
  %>
        <td valign=top>
	        <table>
			 ...
			 <tr>
			  <td>
			   <table align=center width=910 height=90 border=1 cellpadding=0 cellspacing=0 bordercolor=pink>
			    <tr><td colspan=10 height=30 align=center>时时乐 中奖记录</td></tr>
			    <tr height=20>
			    ...
			    <tr height=20>
			     ...
			     if(strPageType.equals("man")){
			    	 out.print("<td width=30><a href=/servlet/useinfprdel?play=lau&prid="+dbcInfo.rsGetString("id")+">删除</a></td>");
			     } %>
			    </tr>
			   <%}%>
			   </table>
			 ...
			 <tr>
			  <td><ctl:page curpage="<%=psInfo.getCurrentPage()%>" maxpage="<%=psInfo.getMaxPage()%>" prevpage="<%=psInfo.getPrevPage()%>" nextpage="<%=psInfo.getNextPage()%>" servhref="servlet/servuserinfo?mark=laupri&"></ctl:page>
			  </td>
			 </tr>
	       </table>
        </td>
