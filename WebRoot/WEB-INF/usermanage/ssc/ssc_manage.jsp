...
<tr><td align=center style="font:bold; font-size=13px; color:red" height="30"><span>时 时 彩</span></td></tr>						  
      <tr width="100%">
         <td>
            ...
            <table>
              <tr>
	           <td align=left style="padding-bottom:10px;padding-top:10px;padding-left:10px;">
	              <a href="/ssc/sscManage.do?method=showZhongjianghaoma">中奖号码查询</a>
	           </td>
	           <td>
              ...
              <table border=1>
                 <form name="formregtime"  method="post" style="margin-bottom:10px;margin-top:10px;">
				  ...
				  <tr>
			        <td >
                        每天开始时间:
                        <input type="text" name="beginHour"  class="style_int_num"  value="<bean:write name="sscConfigInfo" property="beginHour"/>" size=2>时
                        <input type="text" name="beginMin"  class="style_int_num"  value="<bean:write name="sscConfigInfo" property="beginMin"/>" size=2>分					 
                        ,每期销售:
                        <input type="text" name="sellMin"  class="style_int_num"  value="<bean:write name="sscConfigInfo" property="sellMin"/>" size=2>分钟
                        ,进行
                        <input type="text" name="winMin"  class="style_int_num"  value="<bean:write name="sscConfigInfo" property="winMin"/>" size=2>分钟的开奖
                        ,每天共销售
                        <input type="text" name="dayIssueTimes"  class="style_int_num"  value="<bean:write name="sscConfigInfo" property="dayIssueTimes"/>" size=2>期
				  ...
				  <tr>					                    
                     <td >
					   ...
					   <select name="offsetFlag" id="offsetFlag"> 
					      <option value="+" <c:if test="${sscConfigInfo.offsetFlag=='+'}">selected</c:if>>提前</option>
					      <option value="-" <c:if test="${sscConfigInfo.offsetFlag=='-'}">selected</c:if>>滞后</option>
					   </select>&nbsp;&nbsp;
                        <input type="text" name="offsetTime" id="offsetTime" class="style_int_num"  size=10 value='<c:out value="${sscConfigInfo.offsetTime}"/>'/>秒
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 					   <br>
                        <font color=red>
                   ...
                   <form name="formprmonup" action="" method="post" style="margin-bottom:10px;margin-top:10px;">
                      ...
                      <SELECT id="rule" name="rule"  onchange="change_val(this.value)">
						<option value="">请选择...</option>
		                 <OPTION VALUE="wuxingzhixuan" >五星直选
		                 
						 
						 <OPTION VALUE="wuxingtx" >五星通选一等奖
						 <OPTION VALUE="wuxingqian3" >五星通选二等奖
						 <!--
		                 <OPTION VALUE="wuxinghou3" >五星直选后三
						 -->
		                 <OPTION VALUE="wuxingqian2" >五星通选三等奖
						 <!--
		                 <OPTION VALUE="wuxinghou2" >五星直选后二
						 -->
		                 <OPTION VALUE="wuxingzu120" >五星组选一百二十
		                 <OPTION VALUE="wuxingzu60" >五星组选六十
		                 <OPTION VALUE="wuxingzu30" >五星组选三十
		                 <OPTION VALUE="wuxingzu20" >五星组选二十
		                 <OPTION VALUE="wuxingzu10" >五星组选十
		                 <OPTION VALUE="wuxingzu5" >五星组选五
		                 <OPTION VALUE="wuxingzuchong2" >五星组选二重号全包
		                 <OPTION VALUE="wuxingzuchong3" >五星组选三重号全包
		                 <OPTION VALUE="wuxingzuchong4" >五星组选四重号全包

		                 <OPTION VALUE="sixingzhixuan" >四星直选
		                 <OPTION VALUE="sixingzu24" >四星组选二十四
		                 <OPTION VALUE="sixingzu12" >四星组选十二
		                 <OPTION VALUE="sixingzu6" >四星组选六
		                 <OPTION VALUE="sixingzu4" >四星组选四

		                 <OPTION VALUE="sanxingzhixuan" >三星直选
		                 <OPTION VALUE="sanxingzu3" >三星组3
		                 <OPTION VALUE="sanxingzu6" >三星组6
		                 <OPTION VALUE="erxingzhixuan" >二星直选
		                 <OPTION VALUE="erxingzuxuan" >二星组选
		                 <OPTION VALUE="yixingzhixuan" >一星直选
		                 <OPTION VALUE="dxdszhixuan" >大小单双
		                 <OPTION VALUE="renxuan1" >任选1
		                 <OPTION VALUE="renxuan2" >任选2
		                 <OPTION VALUE="renxuan3" >任选3
		              </SELECT>
		              <input type="text" name="money" id="money" value="0" class="style_int_num" size=20 >
					  &nbsp;&nbsp;
					  限制倍数：<input type="text" name="limitOneIssue" id="limitOneIssue" value="0" size=10>倍
		              <input type="button" name="subprmon"   class="style_int_num"  value="更新" onclick="toSubmitLimit()">   	
