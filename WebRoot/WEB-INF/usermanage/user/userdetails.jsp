...
function linkPlat(loc,obj){
  ...
  var arrMark=new Array("tdspuseinf","tduseroperman","tdpokwag","tdpokpri","tdlauwag","tdlaupri","tdhapwag","tdhappri","tdpthwag","tdpthpri","tdSscTz","tdSscZj","tdSxwTz","tdSxwZj","tdExbTz","tdExbZj");
...
<table width="105%" border="1" bordercolor=yellow align="center" cellpadding="0" cellspacing="0" style="margin-bottom:3px;">
	    <tr>
	    <td width="1"></td>
	    <td background="" bgcolor=orange class="image2">
	      <table border="1" bordercolor=yellow cellpadding=0 cellspacing=0>
	        <tr>
	           ...
	           <td id="tduseroperman" onClick=linkPlat('/servlet/servuserinfo?mark=useroperman',this)>信息操作</td>
	           <td>
	             <table>
...
<tr>
<td>
  <iframe name="fraplat" id="fraplat" frameborder="0" width="98%" height="470"  scrolling="yes" src="/servlet/servuserinfo?mark=spuseinf"></iframe>  
</td>
</tr>
</table>
