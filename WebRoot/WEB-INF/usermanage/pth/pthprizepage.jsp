...
%>
 <tr height=10 align=center>
    ...
    <td width=20%><%out.print("<a href=/servlet/pthwinpageshow?prizeid="+userPS.rsGetString("id")+">删除</a>");%><BR></td>
  </tr>
<%//}else{%>
  <!--<tr height=10 align=center>
    <td width=20%><BR></td>
...
<tr>
<td><ctl:page curpage="<%=objPS.getCurrentPage()%>" maxpage="<%=objPS.getMaxPage()%>" prevpage="<%=objPS.getPrevPage()%>" nextpage="<%=objPS.getNextPage()%>" servhref="servlet/pthwinpageshow?"></ctl:page>
  </td>
</tr>
</table>
<%userPS.connClose(); %>
