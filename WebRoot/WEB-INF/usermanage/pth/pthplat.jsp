...
<tr><td align=center style="font:bold; font-size=13px; color:red"><span>排 列 三</span></td></tr>
                <tr>
		           <td>
	                 <table>
	                  <tr>
		        ...
		        <tr>
			        ...
			        <tr>
			            ...
			            <a href=/servlet/pthwinpageshow>中奖号码查询</a>
			            </td>
               ...
               <tr>
                  <td>
		              <table border=0>
		                 ...
		                 <tr>					                    
		                 <td>
		                        期号:<input type="text" name="pthissnum" value="" size=12>
							 中奖号码:
							     <%
							 ...
							 <td>
					            <input type="button" name="bpthwinplus" value="中奖号码添加" onClick="subPth('plus')"> 
             ...
             <tr>
		      ...
		      <tr>
		        ...
		        <form name="formpthque" action="" style="margin-bottom:10px;margin-top:10px;">
		           期号:<input type="text" name="pthissnum" value="" size=12>
		          <input type="button" name="bpthwinquery" value="中奖用户查询" onClick="subPth('query')"> 
				  <font color=red></font>
		        </form>        
		        </td>
		      </tr>
        ...
        <td>
           <table>
                   ...
                   <form name="formprmonup" action="/servlet/prmon" method="post" style="margin-bottom:10px;margin-top:10px;">
                      ...
                      <SELECT id="rule" NAME="rule"  onchange="change_val(this.value)">
						<option value="">请选择...</option>
		                 <OPTION VALUE="pthsingthr" >直选
		                 <OPTION VALUE="pthgrthr" >组三
		                 <OPTION VALUE="pthgrsix" >组六
              ...
              <%PrMoney objPM=new PrMoney(); %>
                 <td>当前奖金为:<br>
                 直选:<%=objPM.getPrMoney("pthprmoney","pthsingthr") %>元
                 组三:<%=objPM.getPrMoney("pthprmoney","pthgrthr") %>元
                 组六:<%=objPM.getPrMoney("pthprmoney","pthgrsix") %>元
