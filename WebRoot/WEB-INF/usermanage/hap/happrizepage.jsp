...
<table  align="center">
<tr>
<td align=center>福 彩 3D 中 奖 信 息
</td>
</tr>
<tr>
<td>
...
%>
 <tr height=10 align=center>
    ...
    <td width=20%><%out.print("<a href=/servlet/hapwinpageshow?prizeid="+userPS.rsGetString("id")+">删除</a>");%><BR></td>
  </tr>
<%//}else{%>
  <!--<tr height=10 align=center>
    <td width=20%><BR></td>
...
<!-- 以上为记录区 -->
<tr>
<td><ctl:page curpage="<%=objPS.getCurrentPage()%>" maxpage="<%=objPS.getMaxPage()%>" prevpage="<%=objPS.getPrevPage()%>" nextpage="<%=objPS.getNextPage()%>" servhref="servlet/hapwinpageshow?"></ctl:page>
  </td>
</tr>
</table>
<%userPS.connClose(); %>
