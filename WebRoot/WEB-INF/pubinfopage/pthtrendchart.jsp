...
<table width="1300" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#000000">
    <tr>
      <td width=10% align=center bgcolor="#f5f5f5"><a href="servlet/entrymain?type=pth">返回排列三</a>
      </td>
      <td height="25" align="center" bgcolor="#f5f5f5">
         <form name="frm" action="/servlet/pthtrendchart" method="post" style="margin:0px; padding:0px">
