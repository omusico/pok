...
<script src="/pokerfunc/mulissue.js" type="text/javascript"></script>
...
<body>
 <table width="98%" border="0" cellspacing="1" cellpadding="2" bgcolor="#BC9E00" align="center">
    <tr> 
      <td bgcolor=FFFFFF height=30 colspan="10"> 
        <input type="checkbox" name="chestmuliss" onClick="switchMulIss()">
    ...
    <tr> 
      <td bgcolor=FFFFFF height=30 colspan="10">
          以上方案总注数为：<span id="curisswagnum" style="color:red; font-weight:bold "></span>
          总金额为：<span id="curissmon" style="color:red; font-weight:bold "></span>元
      </td>
    </tr>
    <tr>
      <td bgcolor=FFFFFF height=30 colspan="10">
        多期总注数为：<span id="mulisswagnum" style="color:red; font-weight:bold "></span>
          总金额为：<span id="mulissmon" style="color:red; font-weight:bold "></span>元
      </td>
    </tr>
    <tr> 
    ...
    <%
      Vector vecWholeIssNum=(Vector)session.getAttribute("wholeissnumvec");
      int issLength=vecWholeIssNum.size();
      String prefixIssCheck="isscheck";
      String prefixIssTd="isstd";
      String prefixTimesText="timestext";

      for(int i=0;i<vecWholeIssNum.size();i++){
    	SingleIssueInfo objSinIssInfo=(SingleIssueInfo)vecWholeIssNum.elementAt(i);
    ...
    %>
	    <tr bgcolor=ffffff align=center> 
		  ...
		  <td height=20 id="<%=isstdID %>">
		    <%=(String)objSinIssInfo.getIssueNumber() %> 
		  </td>
...
<input type="hidden" name="issuelength" value="<%=issLength%>">
</body>
</html>
