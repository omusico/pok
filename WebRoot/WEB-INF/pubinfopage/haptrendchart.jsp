...
<table width="1300" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#000000">
     <tr>
	      <td width=10% align=center bgcolor="#f5f5f5"><a href="servlet/entrymain?type=happy">返回福彩3D</a>
	      </td>
	      <td height="25" align="center" bgcolor="#f5f5f5">
		      <form name="frm" action="/servlet/haptrendchart" method="post" style="margin:0px; padding:0px">
		            <input type="hidden" name="play" value="happy">
		              请选择:&nbsp;&nbsp;
		  	        <select name="issspan" id="issspan" onChange="frm.submit()" >
		  	          <%
		  	            int[] dayValue={366,20,10};
		  	            String[] dayText={"最近366期","最近20期","最近10期"};
