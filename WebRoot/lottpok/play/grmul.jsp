...
<script src="/pokerfunc/pokfunc/groupmul.js"></script>
...
<input type="hidden" name="typepagemark" value="grmul">
...
<tr>
 <td width=712  id="tdchosentog"  bgcolor="FCDDF6" style="padding-left:20px">
 <span id="test"></span>
 </td>
</tr>
<tr>
		      ...
		      <tr >
		        ...
		        <td id="tdhundred">
		         <table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">A</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">2</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">3</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">4</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">5</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">6</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">7</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">8</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">9</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">10</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">J</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">Q</td>
		              <td id="grmulrow" width="43" height="63" class="voidre" onClick="grMulCho(this)">K</td>
		            </tr>
		          </table>
		         </td>
		      </tr>
