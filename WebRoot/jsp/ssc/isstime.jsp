...
<script src="/jsp/ssc/js/ssc_timerun.js" type="text/javascript"></script>
...
<input type="hidden" name="offsetTime" id="offsetTime" value='<c:out value="${configInfo.offsetTime}"/>'>
     ...
     <table width="100%">
         <tr>
            <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="image6" style="margin-bottom:0px;">
            <tr>
            <td width="30">&nbsp;</td>
