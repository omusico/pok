...
<!-------------me----------->
<input type="hidden" name="playType" id="playType" value="dxds">
    ...
    <table height=130 border="0" cellspacing="0" cellpadding="0">
		      <tr>
		        ...
		        <td id="tdshi"><table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseDxdsPlay('shi',this)">大</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseDxdsPlay('shi',this)">小</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseDxdsPlay('shi',this)">单</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseDxdsPlay('shi',this)">双</td>
		            </tr>
		          </table></td>
		      </tr>
		      <tr>
		        ...
		        <td id="tdge"><table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseDxdsPlay('ge',this)">大</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseDxdsPlay('ge',this)">小</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseDxdsPlay('ge',this)">单</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseDxdsPlay('ge',this)">双</td>
		            </tr>
		          </table></td>
		      </tr>
		    </table>
