...
<title>华彩在线-彩票投注网-时时彩-三星-组合复式</title>
...
<input type="hidden" name="playMode" id="playMode" value="zuheFushi">
  ...
  <td bgcolor="#FFFFDD" colspan=2>
    <table height=43 border="0" cellspacing="0" cellpadding="0">
		      ...
		      <tr>
		        ...
		        <td id="tdge"><table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseSanxingZhixuznZuhePlay('ge',this)">0</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseSanxingZhixuznZuhePlay('ge',this)">1</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseSanxingZhixuznZuhePlay('ge',this)">2</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseSanxingZhixuznZuhePlay('ge',this)">3</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseSanxingZhixuznZuhePlay('ge',this)">4</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseSanxingZhixuznZuhePlay('ge',this)">5</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseSanxingZhixuznZuhePlay('ge',this)">6</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseSanxingZhixuznZuhePlay('ge',this)">7</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseSanxingZhixuznZuhePlay('ge',this)">8</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseSanxingZhixuznZuhePlay('ge',this)">9</td>
		            </tr>
		          </table></td>
		      </tr>
		    </table>
    <table width="100%" border="0" cellspacing="5" cellpadding="0" style="border-bottom:#ccc solid 1px; margin-bottom:5px;;">
      <tr>
		...
		<td align="left">
		  <input name="buttonPlus" id="buttonPlus" type="button" class="button_ssl" value="添加" onClick="wagerPlusOfSxZhixuanZuhe()">
