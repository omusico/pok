...
<!--
	...
	function touzhuSubmit(){
		...
		$("#playType").attr("value","renxuan3");
		$("#palyMode").attr("value","renxuan3");
...
<!-------------me----------->
<input type="hidden" name="playType" id="playType" value="renxuan3">
<input type="hidden" name="typeName" id="typeName" value="renxuan3">
<input type="hidden" name="playMode" id="playMode" value="renxuan3">
