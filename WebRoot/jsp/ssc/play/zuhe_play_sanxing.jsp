...
<title>华彩在线-彩票投注网-时时彩-组合--三星</title>
...
<!--
	...
	function touzhuSubmit(){
		...
		//$("#playType").attr("value","zuheSanxing");
...
<!-------------me----------->
<input type="hidden" name="playType" id="playType" value="sanxing">
  ...
  <td bgcolor="#FFFFDD" colspan=2>
    <table height=130 border="0" cellspacing="0" cellpadding="0">
		      ...
		      <tr >
		        ...
		        <td id="tdbai">
		         <table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td align=center  id="bai" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('bai',this)">0</td>
		              <td align=center  id="bai" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('bai',this)">1</td>
		              <td align=center  id="bai" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('bai',this)">2</td>
		              <td align=center  id="bai" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('bai',this)">3</td>
		              <td align=center  id="bai" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('bai',this)">4</td>
		              <td align=center  id="bai" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('bai',this)">5</td>
		              <td align=center  id="bai" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('bai',this)">6</td>
		              <td align=center  id="bai" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('bai',this)">7</td>
		              <td align=center  id="bai" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('bai',this)">8</td>
		              <td align=center  id="bai" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('bai',this)">9</td>
		            </tr>
		          </table>
		         </td>
		      </tr>
		      ...
		      <tr>
		        ...
		        <td id="tdshi"><table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td  align=center  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('shi',this)">0</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('shi',this)">1</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('shi',this)">2</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('shi',this)">3</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('shi',this)">4</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('shi',this)">5</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('shi',this)">6</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('shi',this)">7</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('shi',this)">8</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('shi',this)">9</td>
		            </tr>
		          </table></td>
		      </tr>
		      <tr>
		        ...
		        <td id="tdge"><table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('ge',this)">0</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('ge',this)">1</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('ge',this)">2</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('ge',this)">3</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('ge',this)">4</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('ge',this)">5</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('ge',this)">6</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('ge',this)">7</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('ge',this)">8</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuheSanxingPlay('ge',this)">9</td>
		            </tr>
		          </table></td>
		      </tr>
		    </table>
    <table width="100%" border="0" cellspacing="5" cellpadding="0" style="border-bottom:#ccc solid 1px; margin-bottom:5px;;">
      <tr>
		...
		<td align="left">
          ...
          <input name="buttonRemove" id="buttonRemove" type="button" class="button_ssl" onclick="sscTextRemove(this,3)" value="删除" />
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
      <tr>
        ...
        <td>
          <input id="randone" name="randone" type="button" class="button_ssl" value="机选一注" onClick="randSelect(1,3)">
          <input id="randfive" name="randfive" type="button" class="button_ssl" value="机选五注" onClick="randSelect(5,3)">
          <input id="randten" name="randten" type="button" class="button_ssl" value="机选十注" onClick="randSelect(10,3)">
          </td>
      ...
      <tr>
        <td><table border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>
            <select name="touzhuInfoList" size="4" style="width=210px;" multiple="multiple" onChange="sscTextRemove(this,3)"> </select>
            </td>
            <td>
