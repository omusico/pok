...
<!--
	...
	function touzhuSubmit(){
		...
		$("#playType").attr("value","renxuan2");
		$("#palyMode").attr("value","renxuan2");
...
<!-------------me----------->
<input type="hidden" name="playType" id="playType" value="renxuan2">
<input type="hidden" name="typeName" id="typeName" value="renxuan2">
<input type="hidden" name="playMode" id="playMode" value="renxuan2">
