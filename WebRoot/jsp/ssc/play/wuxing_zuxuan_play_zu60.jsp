...
<title>华彩在线-彩票投注网-时时彩-五星组选60</title>
...
<tr>
  <td bgcolor="#FFFFDD" colspan=2>
    <table height=130 border="0" cellspacing="0" cellpadding="0">
		      ...
		      <tr >
		        <td width=73 height=43 align=center>第2排
		        </td>
		        <td id="tdbai">
		         <table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		      ...
		      <tr>
		        <td height=43 align=center>重复数字
		        </td>
    ...
    <table width="100%" border="0" cellspacing="5" cellpadding="0" style="border-bottom:#ccc solid 1px; margin-bottom:5px;;">
      <tr>
		...
		<td align="left">
		  <input name="buttonPlus" id="buttonPlus" type="button" class="button_ssl" value="添加" onClick="wagerZuxuanPlus('zu60')">
