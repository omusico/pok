...
<!--
	...
	function touzhuSubmit(){
		...
		//$("#playType").attr("value","sanxingZuxuan");
		$("#palyMode").attr("value","hezhi");
...
<input type="hidden" name="playMode" id="playMode" value="hezhi">
  ...
  <td bgcolor="#FFFFDD" colspan=2>
    <table height=43 border="0" cellspacing="0" cellpadding="0">
		      ...
		      <tr>
		        ...
		        <td id="tdge"><table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">0</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">1</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">2</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">3</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">4</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">5</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">6</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">7</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">8</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">9</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">10</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">11</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">12</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">13</td>
		            </tr>
		          </table></td>
		      </tr>			  
		      <tr>
		        ...
		        <td id="tdge"><table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">14</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">15</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">16</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">17</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">18</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">19</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">20</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">21</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">22</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">23</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">24</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">25</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">26</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseHezhiPlay('ge',this)">27</td>
		            </tr>
		          </table></td>
		      </tr>
		    </table>
    <table width="100%" border="0" cellspacing="5" cellpadding="0" style="border-bottom:#ccc solid 1px; margin-bottom:5px;;">
      <tr>
		...
		<td align="left">
		  <input name="buttonPlus" id="buttonPlus" type="button" class="button_ssl" value="添加" onClick="sanxingHezhiPlug()">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
      <tr>
        ...
        <td>
          <input id="randone" name="randone" type="button" class="button_ssl" value="机选一注" onClick="randSelect(1)" disabled>
          <input id="randfive" name="randfive" type="button" class="button_ssl" value="机选五注" onClick="randSelect(5)" disabled>
          <input id="randten" name="randten" type="button" class="button_ssl" value="机选十注" onClick="randSelect(10)" disabled>
          </td>
