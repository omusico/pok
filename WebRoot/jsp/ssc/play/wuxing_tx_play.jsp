...
<title>华彩在线-彩票投注网-时时彩-五星通选</title>
...
<!--
	...
	function touzhuSubmit(){
		...
		//formwager.action = "/ssc/sscPlay.do?method=saveWxtxPlayInfo";
...
<input type="hidden" name="typeName" id="typeName" value="tx">
