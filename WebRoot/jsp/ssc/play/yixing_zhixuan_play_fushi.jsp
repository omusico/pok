...
<!--
	...
	function touzhuSubmit(){
		...
		//$("#playType").attr("value","yixingZhixuan");
...
<!-------------me----------->
<input type="hidden" name="playType" id="playType" value="yixing">
