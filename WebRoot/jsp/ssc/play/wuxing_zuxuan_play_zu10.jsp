...
<title>华彩在线-彩票投注网-时时彩-五星组选10</title>
...
<input type="hidden" name="playMode" id="playMode" value="zu10">
...
<tr>
  <td bgcolor="#FFFFDD" colspan=2>
    <table height=130 border="0" cellspacing="0" cellpadding="0">
		      ...
		      <tr>
		        <td height=43 align=center>二重号
		        </td>
		        <td id="tdshi"><table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td  align=center  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZu10Play('shi',this,'0')">0</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZu10Play('shi',this,'1')">1</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZu10Play('shi',this,'2')">2</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZu10Play('shi',this,'3')">3</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZu10Play('shi',this,'4')">4</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZu10Play('shi',this,'5')">5</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZu10Play('shi',this,'6')">6</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZu10Play('shi',this,'7')">7</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZu10Play('shi',this,'8')">8</td>
		              <td  align=center id="shi" width="66" height="43" class="plare" onClick="chooseZu10Play('shi',this,'9')">9</td>
		            </tr>
		          </table></td>
		      </tr>
		      <tr>
		        ...
		        <td id="tdge"><table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZu10Play('ge',this,'0')">0</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZu10Play('ge',this,'1')">1</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZu10Play('ge',this,'2')">2</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZu10Play('ge',this,'3')">3</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZu10Play('ge',this,'4')">4</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZu10Play('ge',this,'5')">5</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZu10Play('ge',this,'6')">6</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZu10Play('ge',this,'7')">7</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZu10Play('ge',this,'8')">8</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZu10Play('ge',this,'9')">9</td>
		            </tr>
		          </table></td>
		      </tr>
		    </table>
    <table width="100%" border="0" cellspacing="5" cellpadding="0" style="border-bottom:#ccc solid 1px; margin-bottom:5px;;">
      <tr>
		...
		<td align="left">
		  <input name="buttonPlus" id="buttonPlus" type="button" class="button_ssl" value="添加" onClick="wagerZuxuanPlus('zu10')">
