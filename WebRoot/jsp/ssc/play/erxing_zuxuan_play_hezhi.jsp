...
<!--
	...
	//	$("#playType").attr("value","erxingZuxuan");
...
<tr width="100%">
  <td bgcolor="#FFFFDD" colspan=2>
    <table  width="700" height=43 border="0" cellspacing="0" cellpadding="0">
		      ...
		      <tr  width="100%">
		        ...
		        <td id="tdge" width="100%"><table border="0" cellspacing="0" cellpadding="0">
		            <tr>
    ...
    <table width="100%" border="0" cellspacing="5" cellpadding="0" style="border-bottom:#ccc solid 1px; margin-bottom:5px;;">
      <tr>
		...
		<td align="left">
		  <input name="buttonPlus" id="buttonPlus" type="button" class="button_ssl" value="添加" onClick="erxingHezhiPlug()">
