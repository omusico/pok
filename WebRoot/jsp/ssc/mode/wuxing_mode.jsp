...
<table width="100%" height=30 border="0">
  <tr>
	    ...
	    <td width="10%" nowrap>
			<input name="radiobutton" type="radio" value="radiobutton" checked onClick="chMode('wuxing_play_fushi')">复式
		</td>
		<td width="10%" nowrap>
			<% //2011-10-05 注销
			 //<input name="radiobutton" type="radio" value="radiobutton"  onClick="chMode('wuxing_play_danshi')">单式
			%>
		</td>
