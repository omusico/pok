...
function wagerPlayCalEach(){
  ...
  var a1 = arrQuanForPlay[0]*arrQuanForPlay[1]*arrQuanForPlay[2]
		 + arrQuanForPlay[0]*arrQuanForPlay[1]*arrQuanForPlay[3]
		 + arrQuanForPlay[0]*arrQuanForPlay[1]*arrQuanForPlay[4]
	     + arrQuanForPlay[0]*arrQuanForPlay[2]*arrQuanForPlay[3] 
	     + arrQuanForPlay[0]*arrQuanForPlay[2]*arrQuanForPlay[4] 
	     + arrQuanForPlay[0]*arrQuanForPlay[3]*arrQuanForPlay[4];

  var a2 = arrQuanForPlay[1]*arrQuanForPlay[2]*arrQuanForPlay[3]
	     + arrQuanForPlay[1]*arrQuanForPlay[2]*arrQuanForPlay[4]
	     + arrQuanForPlay[1]*arrQuanForPlay[3]*arrQuanForPlay[4]

  var a3 = arrQuanForPlay[2]*arrQuanForPlay[3]*arrQuanForPlay[4];
 
   totalQuan = a1 + a2 + a3;
  //alert("totalQuan="+totalQuan);
...
function randSelectOneCom(){
  ...
  var ranNumFig=generRandomNum(0,9);
  return ranNumFig;
}
