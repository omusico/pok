...
<!--
	function to_del(issueNum){
		//alert("del  :"+issueNum);
		window.location.href = "/ssc/sscManage.do?method=deleteZhongjianghaoma&issueNum="+issueNum;
	}
//-->
</SCRIPT>
...
<table  align="center">
<tr>
<td align=center>时时彩中奖信息
</td>
</tr>
<tr>
<td>
<display:table name="zjhmList" cellspacing="0" cellpadding="0"  pagesize="10" requestURI="/ssc/sscManage.do?method=showZhongjianghaoma"  decorator="com.onmyway.common.displaytag.DisplayTagWrapper">
...
<display:column property="ge" title="个位"/>
 <display:column property="sscZhongjianghaomaHref" title="操作" />
