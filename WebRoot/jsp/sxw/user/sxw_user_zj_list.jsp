...
<html>
<head>
<title>管理平台-12选5 用户中奖信息显示</title>
<style type="text/css">
...
<!--
	...
	if(confirm("删除后将无法恢复，确实要删除吗?")){
 		var url = "/sxw/sxwPublicInfo.do?method=delUserZjInfo&tzId="+tzId+"&userId=<%=userId%>";
...
<td>
		<display:table name="userZjList" cellspacing="0" cellpadding="0"   pagesize="10" class="table"  requestURI="/sxw/sxwPublicInfo.do?method=viewUserZjInfo"  decorator="com.onmyway.common.displaytag.DisplayTagWrapper">
       ...
       <%
		...
		%>
			<display:column property="sxwUserZhongjiangHref" title="操作" />
