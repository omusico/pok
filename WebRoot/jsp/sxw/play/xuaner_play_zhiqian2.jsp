...
<title>华彩在线-彩票投注网-12x5-任选2-选前二直选</title>
...
<input type="hidden" name="playMode" id="playMode" value="zhiqian2">
		 ...
		 <input id="method" name="method" type="radio" value="empty" onClick="choosePlayByRadio(this)">空
			...
			<tr>
		        ...
		        <td id="tdge"><table border="0" cellspacing="0" cellpadding="0">
					<tr>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('shi',this)">1</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('shi',this)">2</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('shi',this)">3</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('shi',this)">4</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('shi',this)">5</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('shi',this)">6</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('shi',this)">7</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('shi',this)">8</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('shi',this)">9</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('shi',this)">10</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('shi',this)">11</td> 
		            </tr>

		            <tr>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('ge',this)">1</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('ge',this)">2</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('ge',this)">3</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('ge',this)">4</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('ge',this)">5</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('ge',this)">6</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('ge',this)">7</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('ge',this)">8</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('ge',this)">9</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('ge',this)">10</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZhiqian2Play('ge',this)">11</td>
		            </tr>
		          </table></td>
		      </tr>
		    </table>
