...
<!--
	...
	function touzhuSubmit(){
		...
		$("#palyMode").attr("value","zuqian2dantuo");
...
<input type="hidden" name="playMode" id="playMode" value="zuqian2dantuo">
