...
<title>华彩在线-彩票投注网-11选5</title>
<link href="/pokercss/main.css" rel="stylesheet" type="text/css" />

<script src="/jsp/sxw/js/sxw_play.js" type="text/javascript"></script>
...
<body>
<input type="hidden" name="pagemark" value="sxw">
...
<tr><td align="center"><span id="palytitle" style="font:bold; font-size:13px; color:red">11 选 5</span></td></tr>
</table>
<!---------开奖动画----------------->
<table  border=0 cellpadding="0" cellspacing="0">
     <tr>
        <td>
			...
			<iframe name="frawinmovie" id="frawinmovie" frameborder="0" width="920" height="120"  scrolling="no" src="/sxw/sxwPublicInfo.do?method=showSxwWinMovie"></iframe>
      ...
      <tr>  
		...
		<td width="200"  valign=top>
          <table width="200" border="1" cellspacing="0" cellpadding="0" >
            ...
            <tr>
             <td align=center>
                <iframe name="frawinnumshow" id="frawinnumshow" frameborder="0" width="200" height="290"  scrolling="no" src="/sxw/sxwPublicInfo.do?method=showSxwZjNum"></iframe>
             </td>
            </tr>
			<!-----------开奖号码走势图 begin------------>
            <tr>
			...
			<tr bgcolor=white>
		        ...
		        <form name="formpokque" action="/sxw/sxwManage.do?method=findZjUserInfo" method="post" target="_blank" style="margin-bottom:10px;margin-top:10px;">
        ...
        <td width="700" align=center>
		   ...
		   <!-----------时间信息----------->
			...
			<tr>
			 ...
			 <!-------------类型------------>
			   <tr>
			    ...
			    <td>
			     <iframe name="fratyptit" id="fratyptit" frameborder="0" width="630" height="30"  scrolling="no" src="/jsp/sxw/sxw_type.jsp"></iframe>
			    </td>
			   </tr>
			   <!-------------模式------------->
			   <tr>
			    ...
			    <td align="left">
			     <iframe name="framodtit" id="framodtit" frameborder="0" width="450" height="30"  scrolling="no" src="/jsp/sxw/mode/xuanyi_mode.jsp"></iframe>
		        </td>
			   </tr>
			   <tr>
	        ...
	        <tr>
               <td>
                 <iframe name="frameTouzhu" frameborder="0" width="700" height="420"  scrolling="no" src="/jsp/sxw/play/xuanyi_play_fushi.jsp" onreadystatechange="playLoad()"></iframe>
               </td>
            </tr>
			...
			<tr>
               <td>
                  <iframe name="frameZhuitou"  frameborder="0" width="700" height="310"  scrolling="yes" src="/sxw/sxwPublicInfo.do?method=showSxwZhuitou"></iframe>
               </td>
