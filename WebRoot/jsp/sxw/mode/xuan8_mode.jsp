...
<title>华彩在线-彩票投注网-12x5-任选8</title>
...
<table width="100%" height=30 border="0">
  <tr>
	 <td width="35%">
			...
			<input name="radiobutton" type="radio" value="radiobutton" checked onClick="chMode('xuan8_play_fushi')">复式
			<input name="radiobutton" type="radio" value="radiobutton" onClick="chMode('xuan8_play_dantuo')">胆拖
	</td>
