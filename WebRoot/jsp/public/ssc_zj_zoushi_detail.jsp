...
<%@ page import="com.onmyway.ssc.manage.model.SscZjNumConfig" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
<title>华彩在线-彩票投注网--时时彩--中奖走势</title>
...
<table width="1300" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#000000">
   <tr>
      ...
      <td height="25" align="left" bgcolor="#f5f5f5">
	      <form name="queryForm" action="/ssc/sscPublicInfo.do?method=showSscZoushi" method="post" style="margin:0px; padding:0px">
...
<table width="1300" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#000000">
      ...
      <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
        <tbody>
          <tr>
            ...
            <td height="25" colspan="10" align="center" bgcolor="#e5e5e5" class="line_bottom_1 line_left_1"><strong><font color="#000000">万位</font></strong></td>
            <td colspan="10" align="center" bgcolor="#e5e5e5" class="line_bottom_1 line_left_1"><strong><font color="#000000">千位 </font></strong></td>
            <td colspan="10" align="center" bgcolor="#e5e5e5" class="line_bottom_1 line_left_1"><strong><font color="#000000">百位 </font></strong></td>
    ...
    <%
	      ...
	      List<SscZjNumConfig> list = (List<SscZjNumConfig>)request.getAttribute("zjNumList");
		  
		  for(int m=0; m < list.size(); m++){
			SscZjNumConfig info = list.get(m);
	%>	
           <tr class='td10'>
