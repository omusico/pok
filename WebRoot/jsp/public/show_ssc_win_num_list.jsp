...
<body>
	...
	<%
	 ...
	 for(SscZjNumConfig zjNum : list){
		...
		wan = Integer.parseInt(wan) < 10 ? (""+wan) : wan;
		qian = Integer.parseInt(qian) < 10 ? (""+qian) : qian;
		bai = Integer.parseInt(bai) < 10 ? (""+bai) : bai;
		shi = Integer.parseInt(shi) < 10 ? (""+shi) : shi;
		ge = Integer.parseInt(ge) < 10 ? (""+ge) : ge;
	%>
	    <tr>
