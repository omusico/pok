...
<title>华彩在线-彩票投注网-快乐十分-选4</title>
...
<table width="100%" height=30 border="0">
  <tr>
	  <td width="35%">
			...
			<input name="radiobutton" type="radio" value="radiobutton" checked onClick="chMode('xuan4_play_renxuan')">复式
			<input name="radiobutton" type="radio" value="radiobutton" onClick="chMode('xuan4_play_dantuo')">胆拖
	</td>
