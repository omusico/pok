...
<html >
<head>
<title>华彩在线-彩票投注网-12选5追投页面</title>

<script src="/jsp/sxw/js/sxw_zhuitou.js" type="text/javascript"></script>
...
<body>
 <table width="100%" border="0" height="100%" cellspacing="1" cellpadding="2" bgcolor="#BC9E00" align="center">
    <tr> 
    ...
    <%
	  ...
	  //为了防止页面不刷新，导致的追投页面显示的还是原来的期号，做此验证2012-01-03
	  if(otherIssueList != null && otherIssueList.size() > 0){
		SingleIssueInfo tempInfo = otherIssueList.get(0);//得到当前期
    %>
		<input type="hidden" name="ztPageCurIssueNum" id="ztPageCurIssueNum" value="<%=(String)tempInfo.getIssueNumber()%>"/>
	<%
	  }else{
	%>
