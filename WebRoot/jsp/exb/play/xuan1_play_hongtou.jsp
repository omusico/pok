...
<!--
	...
	function touzhuSubmit(){
		...
		$("#playType").attr("value","xuan1");
		$("#palyMode").attr("value","hongtou");
...
<input type="hidden" name="playMode" id="playMode" value="hongtou">
  ...
  <td align="left" colspan=2><b>选择号码：</b></td>
		 ...
		 <input id="method" name="method" type="radio" value="empty" onClick="choosePlayByRadio(this)">空
			...
			<tr>
		        ...
		        <td id="tdge"><table border="0" cellspacing="0" cellpadding="0">
		            <tr align="left">
		              <td  align=center id="ge" width="66" height="43" bgcolor="red" class="plare" onClick="chooseFushiPlay('ge',this)">19</td>
		              <td  align=center id="ge" width="66" height="43"  bgcolor="red"  class="plare" onClick="chooseFushiPlay('ge',this)">20</td> 
					  <td>&nbsp;</td>
		            </tr> 
		          </table></td>
		      </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
      <tr>
        ...
        <td>
          <input id="randone" name="randone" type="button" class="button_ssl" value="机选一注" onClick="randSelectHongtou(1)">
          <input id="randfive" name="randfive" type="button" class="button_ssl" value="机选五注" onClick="randSelectHongtou(5)">
          <input id="randten" name="randten" type="button" class="button_ssl" value="机选十注" onClick="randSelectHongtou(10)">
          </td>
