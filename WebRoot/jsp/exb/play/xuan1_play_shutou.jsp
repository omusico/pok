...
<title>华彩在线-彩票投注网-快乐时分-选一-复式</title>
...
<!-------------me----------->
<input type="hidden" name="playType" id="playType" value="xuan1">
<input type="hidden" name="playMode" id="playMode" value="shutou">
  ...
  <td align="left" colspan=2><b>选择号码：</b></td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
      <tr>
        ...
        <td>
          <input id="randone" name="randone" type="button" class="button_ssl" value="机选一注" onClick="randSelectShutou(1)">
          <input id="randfive" name="randfive" type="button" class="button_ssl" value="机选五注" onClick="randSelectShutou(5)">
          <input id="randten" name="randten" type="button" class="button_ssl" value="机选十注" onClick="randSelectShutou(10)">
          </td>
