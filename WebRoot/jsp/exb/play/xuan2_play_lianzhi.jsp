...
<title>华彩在线-彩票投注网-快乐时分-选2-选前二直选</title>
...
<input type="hidden" name="playMode" id="playMode" value="lianzhi">

<input type="hidden" name="issueType" id="issueType" value="sxw">
	 ...
	 <td width="100%"  id="tdchosentog"  bgcolor="FCDDF6" style="padding-left:20px" colspan="2">
		...
		<!--
		 ...
		 -->
			  ...
			  <tr>
		        <td height=43 align="center" width="12%"><b>连直1位：</b></td> 
		        <td id="tdge">
				   <table border="0" cellspacing="0" cellpadding="0">
					<tr>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">1</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">2</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">3</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">4</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">5</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">6</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">7</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">8</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">9</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">10</td> 
		            </tr>		
					<tr>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">11</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">12</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">13</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">14</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">15</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">16</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">17</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">18</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">19</td>
		              <td  align="center" id="shi" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('shi',this)">20</td> 
		            </tr> 
		          </table></td>
		      </tr>
 
			  <tr>
		        <td height=43 align="center" width="12%"><b>连直2位：</b></td> 
		        <td id="tdge">
				   <table border="0" cellspacing="0" cellpadding="0">
					 <tr>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">1</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">2</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">3</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">4</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">5</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">6</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">7</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">8</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">9</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">10</td> 
		            </tr>		
					<tr>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">11</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">12</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">13</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">14</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">15</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">16</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">17</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">18</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">19</td>
		              <td  align="center" id="ge" width="66" height="43" class="plare" onClick="choose2LianzhiPlay('ge',this)">20</td> 
		            </tr> 
		          </table></td>
		      </tr>
