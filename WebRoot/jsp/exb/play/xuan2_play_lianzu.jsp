...
<title>华彩在线-彩票投注网-快乐时分-选2-选前二组选</title>
...
<input type="hidden" name="playMode" id="playMode" value="lianzu">
  ...
  <td align="left" colspan=2><b>选择号码：</b></td>
		 ...
		 <input id="method" name="method" type="radio" value="empty" onClick="choosePlayByRadio(this)">空
			...
			<tr>
		        ...
		        <td id="tdge"><table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">1</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">2</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">3</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">4</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">5</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">6</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">7</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">8</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">9</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">10</td> 
		            </tr>
		            <tr>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">11</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">12</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">13</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">14</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">15</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">16</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">17</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">18</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">19</td>
		              <td  align=center id="ge" width="66" height="43" class="plare" onClick="chooseZuqian2Play('ge',this)">20</td> 
		            </tr>
		          </table></td>
		      </tr>
		    </table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
      <tr>
        ...
        <td>
          <input id="randone" name="randone" type="button" class="button_ssl" value="机选一注" onClick="randSelect(1,true)">
          <input id="randfive" name="randfive" type="button" class="button_ssl" value="机选五注" onClick="randSelect(5,true)">
          <input id="randten" name="randten" type="button" class="button_ssl" value="机选十注" onClick="randSelect(10,true)">
          </td>
