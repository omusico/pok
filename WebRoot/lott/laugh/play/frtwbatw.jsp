...
<script src="/pokerfunc/laughfunc/lfrtw.js"></script>
...
<input type="hidden" name="typepagemark" value="frtwbatw">
...
<input type="hidden" name="playtype" value="前二后二">
<input type="hidden" name="playmode" value="后二">
		      ...
		      <tr disabled>
		        ...
		        <td id="tdhundred">
		         <table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td align=center  id="hundred" width="66" height="43" class="plare">0</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare">1</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare">2</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare">3</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare">4</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare">5</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare">6</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare">7</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare">8</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare">9</td>
		            </tr>
		          </table>
		         </td>
		      </tr>
