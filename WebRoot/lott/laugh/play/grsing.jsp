...
<script src="/pokerfunc/laughfunc/lgrsing.js"></script>
...
<input type="hidden" name="typepagemark" value="grsing">
...
<input type="hidden" name="playtype" value="组单">
...
<tr>
  <td bgcolor="#FFFFDD" colspan=2>
    <table height=130 border="0" cellspacing="0" cellpadding="0">
		      <tr >
		        <td width=73 height=43 align=center>第一个数
		        </td>
		        <td id="tdhundred">
		      ...
		      <tr>
		        <td height=43 align=center>第二个数
		        </td>
		      ...
		      <tr>
		        <td height=43 align=center>第三个数
		        </td>
