...
<input type="hidden" name="typepagemark" value="comtotal">
...
<input type="hidden" name="playtype" value="直选">
		      ...
		      <tr >
		        <td id="tdhundred">
		         <table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              <td align=center  id="hundred" width="66" height="43" class="plare" onClick="totalChoPla('hundred',this)">0</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare" onClick="totalChoPla('hundred',this)">1</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare" onClick="totalChoPla('hundred',this)">2</td>
		        ...
		        <td height=43 align=center>
                  <table border="0" cellspacing="0" cellpadding="0">
		            <tr>
		              ...
		              <td align=center  id="hundred" width="66" height="43" class="plare" onClick="totalChoPla('hundred',this)">25</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare" onClick="totalChoPla('hundred',this)">26</td>
		              <td align=center  id="hundred" width="66" height="43" class="plare" onClick="totalChoPla('hundred',this)">27</td>
		            </tr>
		          </table>
		        </td>
		      </tr>
