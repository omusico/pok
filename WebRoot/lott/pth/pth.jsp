...
<input type="hidden" name="pagemark" value="pth">
...
<tr><td align="center"><span id="palytitle" style="font:bold; font-size:13px; color:red">排 列 三</span></td></tr>
</table> 
    <!--Main Body-->
      ...
      <tr>  
	   ...
	   <td width="200"  valign=top>
          <table width="200" border="1" cellspacing="0" cellpadding="0" >
            ...
            <tr>
             <td align=center>
                <iframe name="frawinnumshow" id="frawinnumshow" frameborder="0" width="200" height="290"  scrolling="no" src="/servlet/winnumshow?play=pth"></iframe>
             </td>
            </tr>
            <tr>
			...
			<tr>
		        ...
		        <form name="formpthque" action="/servlet/pthwinquery" target="_blank" style="margin-bottom:10px;margin-top:10px;">
		          <input type="submit" name="bpthwinquery" value="中奖用户查询"> 
		          <br>请输入期号:<input type="text" name="pthissnum" value="" size=9>
				</form>        
		        </td>
		      </tr>
			<tr>
         ...
         <table width="700" border="3" cellspacing="0" cellpadding="0" bordercolordark="#FFFFFF" bordercolorlight="#cccccc">
          ...
          <tr>
		     ...
		     <td width="86%" valign="bottom" bgcolor="#E8E3FB" style="padding:0px; padding-left:0px;">
		        <iframe src="/lott/pth/typetitle.jsp" name="fratyptit" id="fratyptit" frameborder="0" width="600" height="30"  scrolling="no"></iframe>
		     </td>
		   </tr>
		   <tr>
			   <td align="center" bgcolor="#F9E3F9">投注方式：</td>
			   <td>
			      <iframe src="/lott/pth/mode/modtitcom.jsp" name="framodtit" id="framodtit" frameborder="0" width="600" height="30"  scrolling="no"></iframe>
			   </td>
		   </tr>
		   <tr>
			   <td align="center" bgcolor="#E8E3FB">选择号码： </td>
			   <td>
               <iframe name="fraplay" id="fraplay" frameborder="0" width="600" height="400"  scrolling="no" src="/lott/pth/play/commul.jsp" onreadystatechange="playLoad()"></iframe>
             </td>
		   </tr>
       </table>         
    </td>
