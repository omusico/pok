 ...
 * @Version:1.0
 */
public class ExbIssuePublicServiceImpl implements IExbIssuePublicService{
	
	private Log logger = LogFactory.getLog(ExbIssuePublicServiceImpl.class);
	...
	public List<SingleIssueInfo> getTodayOtherIssue(){
		...
		ExbBaseInfoConfig info = getTodayConfig();
		//当天的设置信息
