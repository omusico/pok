 ...
 * @deprecated
 */
public class ExbZjServiceImpl implements IExbZjService {

	Logger log = Logger.getLogger(ExbZjServiceImpl.class);
	...
	public String setZjInfo(String issueNum, String zjNum) {
		...
		if(len < 5){
			return "快乐十分 开奖号码设置有误!";
		}
		String delSql = "delete from exb_zj_info where issue_num='" + issueNum + "'";
...
//			String erzhong2 = strWan + "," + strQian;//任选2中2
			...
			//任选5中5
			String sqlWuzhong5 = " select t.id as c_id,t.p_id,t.issue_num,t.play_type as c_play_type,t.type_name,t.play_mode as c_play_mode,t.num_times,t.is_zhuitou  from exb_tz_detail t where t.issue_num='"+issueNum 
						   + "' and t.play_type='renxuan5'  and t.num_detail like  '%|" + wuzhong5+"|%'";
	
			//任选4中4
			String sqlSizhong4 = " select t.id as c_id,t.p_id,t.issue_num,t.play_type as c_play_type,t.type_name,t.play_mode as c_play_mode,t.num_times,t.is_zhuitou  from exb_tz_detail t where t.issue_num='"+issueNum 
						   + "' and t.play_type='renxuan4'  and t.num_detail like  '%|" + sizhong4+"|%'";
			//5中4
			String sqlWuzhong4 = " select t.id as c_id,t.p_id,t.issue_num,t.play_type as c_play_type,t.type_name,t.play_mode as c_play_mode,t.num_times,t.is_zhuitou  from exb_tz_detail t where t.issue_num='"+issueNum 
			...
			//任选3中3
			String sqlSanzhong3 = " select t.id as c_id,t.p_id,t.issue_num,t.play_type as c_play_type,t.type_name,t.play_mode as c_play_mode,t.num_times,t.is_zhuitou  from exb_tz_detail t where t.issue_num='"+issueNum 
						   + "' and t.play_type='renxuan3'  and t.num_detail like  '%|" + sanzhong3+"|%'";
			//5中3
			String sqlWuzhong3 = " select t.id as c_id,t.p_id,t.issue_num,t.play_type as c_play_type,t.type_name,t.play_mode as c_play_mode,t.num_times,t.is_zhuitou  from exb_tz_detail t where t.issue_num='"+issueNum 
			...
			//任选2中2
			String sqlSanzhong2 = " select t.id as c_id,t.p_id,t.issue_num,t.play_type as c_play_type,t.type_name,t.play_mode as c_play_mode,t.num_times,t.is_zhuitou  from exb_tz_detail t where t.issue_num='"+issueNum 
						   + "' and t.play_type='renxuan2'  and t.num_detail like  '%|" + erzhong2+"|%'";
			//5中2
			String sqlWuzhong2 = " select t.id as c_id,t.p_id,t.issue_num,t.play_type as c_play_type,t.type_name,t.play_mode as c_play_mode,t.num_times,t.is_zhuitou  from exb_tz_detail t where t.issue_num='"+issueNum 
			...
			//任选1中1
			String sqlSanzhong1 = " select t.id as c_id,t.p_id,t.issue_num,t.play_type as c_play_type,t.type_name,t.play_mode as c_play_mode,t.num_times,t.is_zhuitou  from exb_tz_detail t where t.issue_num='"+issueNum 
			...
			String sql = "select a.ID,a.user_id,a.user_name,a.play_type,a.play_mode,a.touzhu_num,b.* from exb_tz_info a,(" + tempSql + ")b where a.id=b.p_id and a.is_valid='1'";
...
//					String cPlayType = crs.getString("c_play_type");//子表中的play_type
					...
					if(tempPlayType.equals(ConstantSymbol.RX5)){//5选5中5
						...
						int wuzhong5Money = prizeMap.get(ConstantSymbol.RX5)*wuzhong5Times;
