package com.onmyway.sxw.play.model;
...
public class SxwTzInfo implements java.io.Serializable {
	...
	private List<SxwTzDetail> detailList = new ArrayList<SxwTzDetail>();//一对多关联；投注信息表（1...n)投注号码明细表

	// Constructors

 

	public SxwTzInfo(String id, String userId, String userName,
			...
			String parentId, String isValid, String touzhuTime,
			...
			String zhuitouInfo, String isSell, List<SxwTzDetail> detailList) {
		super();
		this.id = id;
		this.userId = userId;
	...
	public List<SxwTzDetail> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<SxwTzDetail> detailList) {
		this.detailList = detailList;
	}
