 ...
 * @Version:1.0
 */
public class SxwIssuePublicServiceImpl implements ISxwIssuePublicService{
	
	private Log logger = LogFactory.getLog(SxwIssuePublicServiceImpl.class);
	...
	public List<SingleIssueInfo> getTodayOtherIssue(){
		...
		SxwBaseInfoConfig info = getTodayConfig();
		//当天的设置信息
