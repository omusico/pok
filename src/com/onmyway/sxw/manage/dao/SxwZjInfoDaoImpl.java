 ...
 * @Version:1.0
 */
public class SxwZjInfoDaoImpl extends GenericEntityDAO<SxwZjInfo,String> implements ISxwZjInfoDao{
	
	private Log logger = LogFactory.getLog(SxwZjInfoDaoImpl.class);
	 ...
	 * @throws DAOException
	 */
	public List<SxwZjInfo> getZjInfo(String issueNum,String userName) throws DAOException{
		String sql = "from SxwZjInfo t where 1=1";
		...
		List<SxwZjInfo> list = getList(sql);
		return list;
	}
	 ...
	 * @throws DAOException
	 */
	public List<SxwZjInfo> getZjInfo(String issueNum,String userName,String userId) throws DAOException{
		String sql = "from SxwZjInfo t where 1=1";
	...
	public boolean delUserZjInfo(String tzId,String userId) throws DAOException {
		//SxwZjInfo info = get(zjId);
		
		//得到相应的中奖金额
		String tzMoney = "0";
		String sql5 = "select sum(t.zjMoney) as zjMoney from SxwZjInfo t where t.tzId='" + tzId + "' and userId='" + userId + "'";
		List<SxwZjInfo> list = getList(sql5);
		if(!list.isEmpty()){
//			SxwZjInfo info = list.get(0);
//			tzMoney = info.getZjMoney();
	...
	public void deleteHistoryZjInfo(String issueNum) throws DAOException{
		String sql = "delete from SxwZjInfo t where t.issueNum='" + issueNum + "'";
		update(sql);
