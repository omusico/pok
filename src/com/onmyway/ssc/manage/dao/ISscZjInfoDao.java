...
/**
 * @Title:时时彩-后台管理-数据操作-对中奖用户信息进行操作
 * @Description: 
 * @Create on: Aug 14, 2010 5:36:59 PM
 * @Author:LJY
 * @Version:1.0
 */
public interface ISscZjInfoDao extends  EntityDAO<SscZjInfo,String>{
	 ...
	 * @return
	 */
	public SscZjInfo getUserTotalZjInfo(String issueNum,String userId) throws DAOException;
	/**
