...
public class HapWinQuery extends HttpServlet{
	...
	//判断是否已经登陆	 
	 ...
	 if(obj == null){
		 ...
		 if(userName == null || userName.equals("")){
			 ...
			 String issueNum = new String(req.getParameter("hapissnum").getBytes("ISO8859_1"),"GB2312").trim();
		     DataBaseConn winQueryDBC=new DataBaseConn();
		   //alter by ljy on 2009-08-30
		     String sql = "";
		     if(userName.equals("admin")){
		    	 sql = "select * from happrizeinfo where 1=1";
		     }else{
		    	 sql = "select * from happrizeinfo where  username='" + userName + "'";
		     ...
		     //winQueryDBC.execQuery("select * from happrizeinfo where issuenum='"+issueNum+"';");
