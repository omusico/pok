...
public class PthWinQuery extends HttpServlet{
 ...
 throws IOException,ServletException{
	...
	//判断是否已经登陆	 
	 ...
	 if(obj == null){
		 ...
		 String issueNum = new String(req.getParameter("pthissnum").getBytes("ISO8859_1"),"GB2312").trim();
	     DataBaseConn winQueryDBC=new DataBaseConn();
	     //alter by ljy on 2009-08-30
	     String sql = "";
	     if(userName.equals("admin")){
	    	 sql = "select * from pthprizeinfo where 1=1 ";
	     }else{
	    	 sql = "select * from pthprizeinfo where  username='" + userName + "'";
	...
	//     winQueryDBC.execQuery("select * from pthprizeinfo where issuenum='"+issueNum+"';");
